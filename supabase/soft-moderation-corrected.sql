...
BEGIN
  ...
  -- Auto-detect region (use GP as default since National is not allowed)
  auto_region := 'GP';
  
  -- Auto-detect category based on content (only use allowed values)
  auto_category := CASE
    ...
    ELSE 'Events' -- Default to Events instead of Community
  END;
